...
export async function createInvoice(prevState: State, formData: FormData): Promise<any | void> {
...
export const deleteInvoice = async (id: string): Promise<void | { message: string }> => {
